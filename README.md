...
Why read it: The shortest serious pass through classical ML, loss, optimization, generalization, and model selection.



### The Deep Learning Math Workbook by Professor Tom Yeh

Why read it: Useful when neural networks, gradients, tensors, and training math still feel too abstract.
...
Why read it: A structured path through linear algebra, calculus, and probability for machine learning.
...
Why read it: A practical deep learning book for model building, training, and modern neural network workflows.
...
Why read it: A mindset book for choosing important problems, learning how to learn, and thinking clearly about technical work.
...
Why read it: Useful when reading performance-sensitive inference, kernels, runtimes, and systems code.
...
Why read it: The systems book for storage, streams, replication, consistency, reliability, and data infrastructure.



### [Designing Machine Learning Systems](https://www.oreilly.com/library/view/designing-machine-learning/9781098107956/) by Chip Huyen

Why read it: The best durable reference for production ML system design, from data loops to monitoring and deployment.



### [Made With ML](https://madewithml.com/) by Goku Mohandas

Why read it: A practical MLOps path from product framing through deployment and monitoring.
...
Why read it: The code-level path from tokenizer and transformer blocks through pretraining and fine-tuning.
...
Why read it: A hands-on bridge from general LLM mechanics into reasoning datasets, reinforcement learning, and verifiable rewards.



### [RLHF Book](https://rlhfbook.com/) by Nathan Lambert

Why read it: The best structured path into preference data, reward models, policy optimization, and post-training tradeoffs.
